...
const assets: DashboardAssets = {
  ...
  evidence: [],
  settlements: [{ assetType: "settlement", schemaVersion: 10, id: "settlement-1", claimId: "claim-review", sourceAccountId: "bank-insurer-premium", destinationAccountId: "showcase-customer-account", transferId: "", amountMinor: 20000, currency: "BDT", status: "AUTHORIZED", failureCode: "", bankReferenceHash: "", authorizedAt: timestamp, confirmedAt: "", updatedAt: timestamp }],
  evidenceAccess: [],
