...
describe("workflow command boundary", () => {
  ...
  it("validates policy, payment, and benefit lifecycle commands", () => {
    expect(workflowCommandSchema.safeParse({ operation: "processPremiumCollection", collectionId: "collection-1", paymentId: "payment-1", transferId: "transfer-1", destinationAccountId: "insurer-account-1", periodEndDate: "2026-01-30", externalReferenceHash: "a".repeat(64) }).success).toBe(true);
