  ...
  return <main className="shell workspace">
    ...
    <section className="roleDashboard">
      ...
      <div className="metricGrid">
        ...
        <article className="metricCard"><span>Indexed events</span><strong>{snapshot.provenance.indexedEvents}</strong><small>{snapshot.provenance.checkpoint ? `Through block ${snapshot.provenance.checkpoint.blockNumber}` : "No checkpoint"}</small></article>
